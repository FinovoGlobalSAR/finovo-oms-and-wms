...
.app-shell { display: flex; min-height: 100vh; background: var(--bg-page); }
...
.sidebar-company .name { font-weight: 600; font-size: 15px; color: var(--text-dark); }
.sidebar-company .chev { margin-left: auto; color: var(--text-light); font-size: 12px; }
...
.sidebar-link.active { background: var(--btn-dark-bg); color: #ffffff; }

.sidebar-link i, .sidebar-search i, .toolbar-btn i, .filter-btn i, .action-link i {
  font-size: 14px;
}

.main-content { flex: 1; padding: 22px 30px; background: var(--bg-page); }
...
.page-subtitle { margin: 0 0 16px; color: var(--text-muted); font-size: 14px; }
...
.btn-primary {
  background: var(--btn-dark-bg); color: #fff; border: 1px solid var(--btn-dark-bg);
  padding: 8px 16px; border-radius: 8px; font-size: 14px; cursor: pointer; font-family: inherit;
}
.btn-secondary {
  background: var(--bg-white); color: var(--text-dark); border: 1px solid var(--border-color);
  padding: 8px 16px; border-radius: 8px; font-size: 14px; cursor: pointer; font-family: inherit;
}
</style>