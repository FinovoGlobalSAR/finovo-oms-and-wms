...
class EmployeeController extends Controller
{
    ...
    private function currentCompanyId(): int
    {
        ...
        if (
            ...
            $_SESSION['error'] =
                'Invalid company session. Please login again.';


            $this->redirect(
                '/finovo-oms-and-wms/public/index.php/login'
            );
        }
    ...
    {
        return
            '/finovo-oms-and-wms/public/index.php/employees';
    }

    private function backWithError(
        string $message
    ): void {
